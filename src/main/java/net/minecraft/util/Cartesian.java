...
public class Cartesian
{
    ...
    static class Product<T> implements Iterable<Object[]>
    {
        ...
        public Iterator<Object[]> iterator()
        {
            ...
            try {
                iterator = (this.iterables.length <= 0 ? Collections.singletonList((Object[]) Cartesian.createArray(this.clazz, 0)).iterator() : new ProductIterator(this.clazz, this.iterables));
            } catch (Exception e)
            {
                e.printStackTrace();
            }
